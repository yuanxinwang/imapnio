...
public class UidSearchCommand extends AbstractSearchCommand {
     ...
     * @throws SearchException when search term cannot be found
     */
    public UidSearchCommand(@Nullable final SearchReturnOption[] options, @Nullable final MessageNumberSet[] msgsets, @Nullable final SearchTerm term,
                            @Nullable final Capability capa) throws ImapAsyncClientException, SearchException, IOException {
        super(true, options, msgsets, term, capa);
    }
     ...
     * @throws SearchException when search term cannot be found
     */
    public UidSearchCommand(@Nullable final SearchReturnOption[] options, @Nullable final String msgNumbers, @Nullable final SearchTerm term,
                            @Nullable final Capability capa) throws ImapAsyncClientException, SearchException, IOException {
        super(true, options, msgNumbers, term, capa);
    }
     ...
     * @throws ImapAsyncClientException when both msgNumber and searchString are null
     */
    public UidSearchCommand(@Nullable final SearchReturnOption[] options, @Nullable final String msgNumbers, @Nullable final String charset,
                            @Nonnull final Argument args, @Nullable final Capability capa) throws ImapAsyncClientException {
        super(true, options, msgNumbers, charset, args, capa);
    }
